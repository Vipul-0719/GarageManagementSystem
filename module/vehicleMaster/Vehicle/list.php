     ...
     <div class="col-12">
        <div class="card">
         <div class="card-body">
            ...
            <hr>
            <button class="btn btn-primary my-5"><a href="add.php" class="text-light">Add Vehicle</a></button>
                <div class="table-responsive">
                 <table id="dataTableVehicle" class="table table-striped table-bordered display nowrap" style="width:100%">
            <!-- <thead> -->
          <!-- <tr> -->
            <thead>
              <tr>
									...
									<th><b>ContactNumber </b></th>		
									<th><b>RegistrationDate </b></th> 
									<th><b>VehicleType </b></th>	
									<th><b>VehicleColor </b></th>	 
									<th><b>FuelType </b></th>	
						            <th><b>ModelName </b></th>	 
                                    <th><b>ModelYear  </b></th>
                                    <th><b>EngineNumber  </b></th>
									<th><b>No.OfGear </b> </th>	 
									<th><b>OdometeReading  </b></th>	 
			...
			$mname= 	$rows['mname'];
            $myear= 	$rows['myear'];
            $enumber= 	$rows['enumber'];
			$ngear= 	$rows['ngear'];
			$oreading= 	$rows['oreading'];
