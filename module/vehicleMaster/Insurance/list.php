 ...
 <?php include '../../connect.php';?>    
    ...
    <div class="row">
     <div class="col-12">
        <div class="card">
         <div class="card-body">
            <h4 class="card-title">Insurance List</h4><hr>
            <button class="btn btn-primary my-5"><a href="add.php" class="text-light">Add Insurance</a></button>
                <div class="table-responsive">
                 <table id="dataTableInsurance" class="table table-striped table-bordered display nowrap" style="width:100%">
            ...
            <thead>
              <tr>
									...
									<th><b>PolicyNumber</b> </th>	
									<th><b>ChargePayable</b></th> 
                                    <th><b>VehicleNumber</b></th>	
                                    <th><b>PolicyDocument</b> </th>
                                    <th><b>StartDate</b> </th>	 
									<th><b>EndDate</b></th> 	 
			...
			$cpayable= 	$rows['cpayable'];
            $vnumber= 	$rows['vnumber'];
			$pdocument= 	$rows['pdocument'];
			$sdate= 	$rows['sdate'];
			$edate= 	$rows['edate'];        
            echo'<tr>
                   <th scope="row">' .$id.'</th>
    ...
    <script>
        $(document).ready(function() {
            $('#dataTableInsurance').DataTable({
                dom: 'Bfrtip',
                buttons: [{
                        extend: 'excelHtml5',
                        title: 'Insurance_List',
