...
$id = $_GET['id'];
// include '../connect.php';
$sql = "SELECT * FROM `serreminder` WHERE `id`='$id'";
        ...
        <div class="row">
            ...
            <div class="col-7 align-self-center">
                <div class="d-flex no-block justify-content-end align-items-center">
                    ...
                    <button class="btn btn-info my-5"><a href="list.php" class="text-light">Manage Service</a></button>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white" style="font-weight: bold;">Update Reminder</h4>
                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-lg-6">
                                    <div class="form-group row">
                                        <label for="Service Name" class="col-sm-3 text-right control-label col-form-label">Reminder Id</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control custom-select"  id="customernm"  name="customernm">
                                                <option value="<?php echo $rows['customernm']; ?>">Select Customer Name</option>
                                                <?php
                                                // include 'connect.php';
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control custom-select"  id="vehiclenm"  name="vehiclenm">
                                                <option value="<?php echo $rows['vehiclenm']; ?>">Select Vehicle Name</option>
                                                <?php
                                                // include 'connect.php';
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control custom-select"  id="service"  name="service">
                                                <option value="<?php echo $rows['service']; ?>">Select Upcoming Service</option>
                                                <?php
                                                // include 'connect.php';
