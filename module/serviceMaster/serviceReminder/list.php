...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Reminder List</h4>
                <hr>
                <button class="btn btn-info my-5"><a href="add.php" class="text-light">Add Service Reminder</a></button>
                <div class="table-responsive">
                    <table id="dataTableReminder" class="table table-striped table-bordered display nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Operation</th>
                        ...
                        $sql = 'SELECT * FROM `serreminder`';
                        $res = mysqli_query($conn, $sql);

                        while ($rows = mysqli_fetch_assoc($res)) {
                            $id = $rows['id'];
                            $customernm = $rows['customernm'];
                            $vehiclenm = $rows['vehiclenm'];
