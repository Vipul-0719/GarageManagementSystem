    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <button class="btn btn-primary my-5"><a href="add.php" class="text-light">Add Unit</a></button>
                <div class="table-responsive">
                    <table id="dataTableUnit" class="table table-striped table-bordered display nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>Unit Id</th>
                                <th>Operation</th>
